...
let xutwamianibutton = document.querySelector(".xutwamianibutton");
let xutwamianip = document.querySelector(".xutwamianip");

xutwamianibutton.addEventListener("click", () => {
  let damtvleli = 5;

  let xutwamianifunqcia = () => {
    if (damtvleli === 0) {
      xutwamianip.textContent = "Text is ready!";
    } else {
      xutwamianip.textContent = `text will be ready in ${damtvleli}`;
      damtvleli--;
    }
  };

  let setintervali = setInterval(xutwamianifunqcia, 1000);
});
